...
path('users', UserProfileViewSet.as_view({'get': 'list', 'post': 'create'}), name='product_list'),
path('users/<int:pk>/', UserProfileViewSet.as_view({'get': 'retrieve', 'put': 'update',
                                               'delete': 'destroy'}), name='product_detail'),


path('category', CategoryViewSet.as_view({'get': 'list', 'post': 'create'}), name='product_list'),
